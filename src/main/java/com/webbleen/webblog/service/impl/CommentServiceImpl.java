...
import com.webbleen.webblog.dao.CommentRepository;
...
/**
 * @author ：webbleen
 * @date ：Created in 2020-06-14 14:03
 * @description：
 */
...
public class CommentServiceImpl implements CommentService {
    ...
    public Comment saveComment(Comment comment) {
        ...
        if (parentComentId != -1) {
            comment.setParentComment(commentRepository.findById(parentComentId).get());
        } else {
